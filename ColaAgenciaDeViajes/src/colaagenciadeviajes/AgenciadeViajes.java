...
public class AgenciadeViajes extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!nombre.isEmpty() && !destino.isEmpty()) {
            colaClientes.add("Cliente: " + nombre + ", Destino: " + destino);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (String cliente : colaClientes) {
            listModel.addElement(cliente); // Añadir cada cliente al modelo
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!colaClientes.isEmpty()) {
            colaClientes.remove(); // Eliminar el primer elemento de la cola
            listModel.clear(); // Limpiar el modelo de la lista
            for (String cliente : colaClientes) {
                listModel.addElement(cliente); // Mostrar la cola actualizada
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgenciadeViajes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgenciadeViajes().setVisible(true);
            }
        });
    }
